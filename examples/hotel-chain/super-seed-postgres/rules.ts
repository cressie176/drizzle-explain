import { derive, randomInteger, randomWords, structuralDefault, weightedPick } from 'drizzle-super-seed';
...
// A drizzle date() column inserts a string, so the generator produces one.
