...
- Worked examples seeding the hotel-chain dataset with [drizzle-super-seed](https://www.npmjs.com/package/drizzle-super-seed): the identical million-reservation dataset the drizzle-seed packages build in a minute or two bulk-loads in a few seconds, via COPY on PostgreSQL and extended INSERTs on MariaDB.
