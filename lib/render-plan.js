const summaryFormatters = {
  maxCost: (breach) => `✘ cost ${breach.observed} exceeds limit ${breach.threshold}`,
  rowEstimateTolerance: (breach) => `✘ row estimate ${breach.observed}x off, limit ${breach.threshold}`,
};

const annotationFormatters = {
  maxCost: (breach) => `✘ cost ${breach.observed} > ${breach.threshold}`,
  rowEstimateTolerance: (breach) => `✘ ${breach.observed}x off, limit ${breach.threshold}`,
};
